...
#define BATTERIES_SWAP_TIME          30000  // 5 minutes = 5*60*1000 = 300000ms
...
*/
  ...
  if(millis()-lcdrefresh>666){
    ...
    case PRIMARY_1_STAY:  
      ...
      lcd.setCursor(18,0); lcd.print("S");      
      break;
    case PRIMARY_2_STAY:
      lcd.setCursor(3,0);  lcd.print("S");
      lcd.setCursor(8,0);  lcd.print("P");
      lcd.setCursor(13,0); lcd.print("S");
      lcd.setCursor(18,0); lcd.print("S");          
      break;
    case PRIMARY_3_STAY:
      lcd.setCursor(3,0);  lcd.print("S");
      lcd.setCursor(8,0);  lcd.print("S");
      lcd.setCursor(13,0); lcd.print("P");
      lcd.setCursor(18,0); lcd.print("S");              
      break;
    case PRIMARY_4_STAY:
      lcd.setCursor(3,0);  lcd.print("S");
      lcd.setCursor(8,0);  lcd.print("S");
      lcd.setCursor(13,0); lcd.print("S");
      lcd.setCursor(18,0); lcd.print("P");              
      break;
   default: 
